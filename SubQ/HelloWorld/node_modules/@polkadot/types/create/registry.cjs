  ...
  for (let i = 0; i < pallets.length; i++) {
    ...
    if (errors.isSome) {
      ...
      for (let i = 0; i < variants.length; i++) {
        ...
        metadataErrors[(0, _util.u8aToHex)(new Uint8Array([sectionIndex, variantIndex]))] = {
...
function injectEvents(registry, metadata, metadataEvents) {
  ...
  for (let i = 0; i < filtered.length; i++) {
    ...
    for (let i = 0; i < variants.length; i++) {
      ...
      metadataEvents[(0, _util.u8aToHex)(new Uint8Array([sectionIndex, index.toNumber()]))] = class extends _Event.GenericEventData {
...
function injectExtrinsics(registry, metadata, metadataCalls) {
  const extrinsics = (0, _index2.decorateExtrinsics)(registry, metadata.asLatest, metadata.version);
