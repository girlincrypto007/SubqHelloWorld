...
export function decodeU8a(registry, u8a, types, count, zip) {
  const [Type, Types, keys] = isFunction(types) ? [types, [], []] : Array.isArray(types) ? [null, types, []] : [null, Object.values(types), Object.keys(types)];
