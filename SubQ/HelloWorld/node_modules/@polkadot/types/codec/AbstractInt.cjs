...
function decodeAbstractInt(value, bitLength, isNegative) {
  ...
  if ((0, _util.isHex)(value, -1, true)) {
    ...
    return new _util.BN(value.toString(), 10).toString();
  }
...
class AbstractInt extends _util.BN {
  constructor(registry, value = 0, bitLength = DEFAULT_UINT_BITS, isSigned = false) {
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _byteLength)[_byteLength] = (0, _classPrivateFieldLooseBase2.default)(this, _bitLength)[_bitLength] / 8;
