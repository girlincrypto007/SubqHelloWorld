...
function extractName(types, {
  ...
  const parts = path.map(p => stringUpperFirst(stringCamelCase(p))).filter((p, index) => ( // Remove ::{misc, pallet, traits, types}::
...
export class GenericPortableRegistry extends Struct {
  constructor(registry, value) {
    ...
    _classPrivateFieldLooseBase(this, _types)[_types] = extractTypeMap(this.types);
  }
