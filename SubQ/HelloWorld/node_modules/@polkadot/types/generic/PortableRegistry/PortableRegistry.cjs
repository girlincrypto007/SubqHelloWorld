...
function extractName(types, {
  ...
  const parts = path.map(p => (0, _util.stringUpperFirst)((0, _util.stringCamelCase)(p))).filter((p, index) => ( // Remove ::{misc, pallet, traits, types}::
...
class GenericPortableRegistry extends _Struct.Struct {
  constructor(registry, value) {
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _types)[_types] = extractTypeMap(this.types);
  }
  ...
  if (path.length === 1 && specialVariant === 'BTreeMap') {
    ...
    return (0, _encodeTypes.withTypeString)(this.registry, {
      ...
      sub: fields.map(({
        ...
        type,
        typeName
      }, index) => _objectSpread(_objectSpread({
...
function _extractFields2(lookupIndex, fields) {
  ...
  if (fields.length === 0) {
    ...
    return _objectSpread(_objectSpread(_objectSpread({}, typeDef), lookupIndex === -1 ? {} : {
      lookupIndex,
      lookupName: (0, _classPrivateFieldLooseBase2.default)(this, _names)[_names][lookupIndex],
...
function _extractFieldsAlias2(fields) {
  ...
  for (let i = 0; i < fields.length; i++) {
    ...
    if (name.isNone) {
      ...
      sub[i] = _objectSpread(_objectSpread({}, typeDef), {}, {
