...
describe('Codegen can generate schema', () => {
    ...
    it('can transform field into correct type', () => {
        ...
        expect((0, types_mapping_1.transformTypes)(testClassName, 'ID')).toBe('string');
        expect((0, types_mapping_1.transformTypes)(testClassName, 'Int')).toBe('number');
        expect((0, types_mapping_1.transformTypes)(testClassName, 'BigInt')).toBe('bigint');
        expect((0, types_mapping_1.transformTypes)(testClassName, 'String')).toBe('string');
        expect((0, types_mapping_1.transformTypes)(testClassName, 'Date')).toBe('Date');
    });
