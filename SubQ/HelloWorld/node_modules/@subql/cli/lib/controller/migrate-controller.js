...
async function prepare(location, manifest) {
    ...
    for (const dataSource of manifest.asV0_2_0.dataSources) {
        dataSource.mapping.file = await cli_ux_1.cli.prompt(`Please provide relative entry path for dataSource ${dataSource.name}'s mapping `, { default: jsonProjectData.main, required: true });
